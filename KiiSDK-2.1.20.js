...
root.KiiUser = (function() {
  ...
  @param {Method} callbacks.success The callback method to call on a successful authentication request
  @param {Method} callbacks.failure The callback method to call on a failed authentication request
  @param {Date} Access token expire time that has received by {@link KiiUser#getAccessTokenObject()}. This param is optional and can be omitted.
  ...
  KiiUser.registerAsPseudoUser = function(callbacks, userFields) {
    ...
    root.Kii.logger("Registering pseudo user " + KiiUser);
      ...
      success: function() {
        ...
        if (callbacks != null) {
          try {
            json = JSON.parse(xhr.responseText);
            if (context != null) {
              user = new root.KiiUserAdmin(context);
              user._updateWithJSON(json);
...
if (b && module.exports) {
  module.exports = {
    exportedClasses: ['KiiQuery', 'KiiUser', 'KiiAppAdminContext', 'KiiClause', 'KiiSCNTwitter', 'KiiUserAdmin', 'KiiObjectAdmin', 'KiiBucketAdmin', 'KiiGroup', 'KiiACL', 'KiiObject', 'KiiGroupAdmin', 'Kii', 'KiiGeoPoint', 'KiiSocialConnect', 'KiiACLAdmin', 'KiiBucket', 'KiiSocialConnectNetwork', 'KiiSDKClientInfo', 'KiiSCNFacebook', 'KiiACLEntry', 'KiiAnonymousUser', 'KiiAnyAuthenticatedUser', 'InvalidDisplayNameException', 'InvalidPasswordException', 'InvalidUsernameException', 'InvalidUserIdentifierException', 'InvalidEmailException', 'InvalidPhoneNumberException', 'InvalidLocalPhoneNumberException', 'InvalidCountryException', 'InvalidURIException', 'InvalidACLAction', 'InvalidACLSubject', 'InvalidACLGrant', 'InvalidLimitException', 'InvalidArgumentException', 'IllegalStateException', 'ArithmeticException', 'KiiSocialNetworkName', 'KiiSite', '_KiiHttpRequestType', 'KiiACLAction'],
    create: function() {
